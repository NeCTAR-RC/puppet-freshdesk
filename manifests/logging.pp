# Class freshdesk::logging
#
#  freshdesk logging configuration
#
# == parameters
#
# [*debug*]
...
#   Defaults to '/var/log/freshdesk'.
#
# [*log_file*]
#   (Optional) File where logs should be stored.
#   Defaults to '/var/log/freshdesk/freshdesk.log'
#
...
#          'websocket' => 'WARN', 'freshdeskmiddleware' => 'WARN',
...
class freshdesk::logging(
  ...
  $log_dir                       = '/var/log/nectar-freshdesk',
  $log_file                      = '/var/log/nectar-freshdesk/nectar-freshdesk.log',
